(function() {
  'use strict';
  var app = angular.module('app.ui.ctrls', []);

  app.controller('NotifyCtrl', [
      ...
      $scope.groups = [
        {
          ...
          title: 'Dynamic Header 2',
          content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.'
        }, {
          title: 'Dynamic Header 3',
          content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.'
        }
      ];
